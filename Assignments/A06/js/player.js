var player_animations = [
  ...
  {
    key: "jump_attack_left",
    atlas_key: "jumpAttack_left",
    start_frame: 0,
    end_frame: 9,
    rate: 20,
    loop: false
  ...
  {
    key: "jump_attack_right",
    atlas_key: "jumpAttack_right",
    start_frame: 0,
    end_frame: 9,
    rate: 20,
    loop: false
...
var Player = function(game, x, y, atlas) {
  ...
  this.game.load.atlas(
    "knight_atlas",
    "assets/sprites/knight_atlas.png",
...
Player.prototype.registerKeys = function() {
  ...
  //To be added
  //this.jumpAttackL = this.game.input.keyboard.addKey(Phaser.Keyboard.X);
  //this.jumpAttackR = this.game.input.keyboard.addKey(Phaser.Keyboard.Z);
};
...
Player.prototype.createPlayer = function(x, y, atlas) {
  ...
  this.player.body.width = this.player.body.width * 0.8;
  this.player.body.height = this.player.body.height * 0.8;
...
Player.prototype.registerAnimation = function(anim, sprite) {
  ...
  this.playerAnimations[anim.key] = sprite.animations.add(
    key,
    Phaser.Animation.generateFrameNames(atlas_key, start, end),
    frame_rate,
    loop
  );
