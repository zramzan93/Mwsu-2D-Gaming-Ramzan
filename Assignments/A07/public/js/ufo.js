function Ufo(game_copy) {
  ...
  this.preLoad = function(
    atlas_name = "ufoAtlas",
    sprite_sheet = "assets/sprites/ufo-sheet_2.png",
    atlas_json = "assets/sprites/ufo-atlas_2.json"
  ) {
  ...
  this.create = function(x, y, x_scale, y_scale) {
    ...
    this.ship.animations.add(
      "hover",
      Phaser.Animation.generateFrameNames("Hover", 1, 12),
      20,
      true
    );
    ...
    this.laserAnimations["laser"] = this.laserSprites.laser.animations.add(
      "laser",
      Phaser.Animation.generateFrameNames("Laser", 1, 9),
      30,
      false
    );
    this.laserAnimations["buildUp"] = this.laserSprites.buildUp.animations.add(
      "buildUp",
      Phaser.Animation.generateFrameNames("BuildUp", 1, 4),
      10,
      false
    );
    this.laserAnimations["blast"] = this.laserSprites.blast.animations.add(
      "blast",
      Phaser.Animation.generateFrameNames("Blast", 1, 3),
      20,
      false
    );
    this.laserAnimations["bolt"] = this.laserSprites.bolt.animations.add(
      "bolt",
      Phaser.Animation.generateFrameNames("Bolt", 1, 4),
      20,
      false
    );
