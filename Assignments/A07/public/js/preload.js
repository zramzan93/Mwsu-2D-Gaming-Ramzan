var preload = {
  preload: function() {
    ...
    var loading_border = this.add.image(
      game.width / 2,
      game.height / 2,
      "assets/images/loading_border"
    );

    loading_border.anchor.setTo(0.5, 0.5);

    var loading = this.add.sprite(
      game.width / 2,
      game.height / 2,
    ...
    game.load.atlas(
      "ufoAtlas",
      "assets/sprites/ufo-sheet_2.png",
      "assets/sprites/ufo-atlas_2.json"
    );
    ...
    game.load.spritesheet("planet1", "assets/sprites/planet1.png", 85, 85, 48);
    game.load.spritesheet("planet2", "assets/sprites/planet2.png", 85, 85, 48);
    game.load.spritesheet("planet3", "assets/sprites/planet3.png", 85, 85, 48);
    game.load.spritesheet("planet4", "assets/sprites/planet4.png", 85, 85, 48);
    game.load.spritesheet("planet5", "assets/sprites/planet5.png", 85, 85, 48);
    game.load.spritesheet("planet6", "assets/sprites/planet6.png", 85, 85, 48);
    game.load.spritesheet("planet7", "assets/sprites/planet7.png", 85, 85, 48);

    game.load.bitmapFont(
      "fontUsed",
      "assets/font/ganonwhite/font.png",
      "assets/font/ganonwhite/font.xml"
    );
  },
